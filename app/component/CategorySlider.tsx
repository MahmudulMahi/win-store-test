...
export default function CategorySlider({ categories }: Props) {
  ...
  return (
    <div className="relative w-full ">
      ...
      <button
        onClick={() => scroll("left")}
        className="absolute left-0 top-1/2 z-10 -translate-y-1/2  rounded-full p-2 text-6xl shadow lg:shadow-none bg-white"
      >
        ‹
      </button>
      ...
      >
        {categories.map((cat, index) => (
          ...
          >
            ...
            <div className="flex items-center justify-between px-2 py-3 absolute bottom-3 trap bg-white/95  w-full -left-3 z-30  border border-gray-200  transform scale-95 ">
      ...
      <button
        ...
        className="absolute right-0 top-1/2 z-10 -translate-y-1/2   rounded-full p-2 text-6xl shadow lg:shadow-none bg-white"
      >
        ›
      </button>
    </div>
